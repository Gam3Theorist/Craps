		...
		while (playAgain== true)	
			{
				...
				System.out.println(+firstDice+" plus "+secondDice+" is "+(firstDice + secondDice)+".");
			boolean rolling = true; 
			    if ( roll == 7 || roll == 11)
			    	
			    	{
			    		System.out.println("Hey, seems like the gods are smiling at ya!");
			    		System.out.println("You won "+bet+"! Your balance is now $"+(money+bet));
			    		 money = money + bet;
			    		 ...
			    		 if (playChoice==1 )
			    			 {
			    				if (money <=0)
			    					{
			    						System.out.println("You can't bet nothing. Come back another day.");
			    					}
			    				else
			    					{
			    				 System.out.println("'Press enter to continue'");
			    ...
			    else if ( roll == 2 || roll ==12)
			    	{
			    		...
			    		System.out.println("You lost"+bet+"... Your balance is now $"+(money-bet));
			    		money = money - bet;
			    		System.out.println("Would you like to play again?");
			    		 System.out.println("1. yes");
			    		 System.out.println("2. no");
			    		...
			    		System.out.println("The point is now "+roll+", 7 will now make you lose.");
	 ...
	 while (rolling == true)
		
		 {
			 int firstDice2 = (int) ((Math.random()*6)+1);
				...
				System.out.println(+firstDice2+" plus "+secondDice2+" is "+(firstDice2 + secondDice2)+".");
			 if (secondRoll == 7)
				 {
		    		 ...
		    		 if (playChoice3==1 )
		    			 {
		    				 ...
		    				 System.out.println("'Press enter to continue'");
		    				 playAgain=true;
								String continue3 = userStringInput.nextLine();
		    			 }
		    				 }
		    		 ...
		    		 if (playChoice4==1 )
		    			 {
		    				 ...
		    				 System.out.println("'Press enter to continue'");
		    				 playAgain=true;
								String continue4 = userStringInput.nextLine();
			    					}
		    				 }
